def kruskal(graph):
    ...
    total_cost = 0  # Variable to store the total cost of the spanning tree
...
print("Enter node1 then its neighbor and then their weights (separated by spaces , use 'done' to finish):")
while True:
    input_str = input()
    if input_str == 'done':
        break
